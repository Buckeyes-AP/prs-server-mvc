...
namespace prs_server_mvc.Controllers
{
    ...
    {
        private readonly PrsDbApiContext _context;

        public RequestLinesController(PrsDbApiContext context)
        {
            _context = context;
        }
        ...
        {
            var prsDbApiContext = _context.RequestLines.Include(r => r.Product).Include(r => r.Request);
